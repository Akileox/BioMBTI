...
function App() {
  ...
  const updateOpenGraphMeta = (resultData) => {
    ...
    const typeImageMap = {
      ...
      'ICGH': '/images/types/ICGH.png',
      'IALR': '/images/types/IALR.png',
      'IAGR': '/images/types/IAGR.png',
      'IALH': '/images/types/ICLR.png',
      'IAGH': '/images/types/ICLR.png',
      'ECLR': '/images/types/ECLR.png',
      'ECLH': '/images/types/ICLR.png',
      'ECGH': '/images/types/ICLR.png',
      'ECGR': '/images/types/ECGR.png',
      'EALR': '/images/types/EALR.png',
      'EALH': '/images/types/EALH.jpg',
      'EAGH': '/images/types/EAGH.png',
